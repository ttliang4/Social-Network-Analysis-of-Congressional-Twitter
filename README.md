# Social Network Analysis of Congressional Twitter
A data analysis project exploring congressional twitter users and their interaction patterns. 
...
## Tools Used
* R (igraph, Matrix, tidyverse, rjson) - Data cleaning, EDA and visualization

## Key Questions Explored
* How does a member’s chamber, party affiliation, and the geographical location of their district impacts which members they interact with on Twitter?
* Are there interaction patterns between the congress members on Twitter?
